...
public class BlockBoard {
	...
	private static BlockBoard instance;
	...
	public void init(int width, int height, Context c) {
		this.width = width;
		this.height = height;
		valid = false;
		
		/* Init Board */
		topRow = new Row(width,c);
		currentIndex = 0;
		tempRow = topRow;
		currentRow = topRow;
		for(int i = 1; i < height; i++) {
			currentRow = new Row(width,c);
			currentIndex = i;
	...
	public static BlockBoard getInstance() {
		if(instance == null)
			instance = new BlockBoard();
		return instance;
	}

	public void setLogic(GameLogic instance2) {
		this.logic = instance2;
	}
	...
	public void finishClear(Row row) {
		...
		topRow = row;
		currentIndex++;
		GameLogic.getInstance().invalidatePhantom();
	}
	...
	public void setCurrentRowIndex(int backup__currentRowIndex) {
		currentIndex = backup__currentRowIndex;
	}

	public void setCurrentRow(Row backup__currentRow) {
		currentRow = backup__currentRow;
	}

	public static void setInstance(BlockBoard bb) {
		instance = bb;
	}
